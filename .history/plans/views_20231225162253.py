...
def checkout(request):
    ...
    if request.method == "GET" and 'plan' in request.GET:
        if request.GET['plan'] == 'yearly':
            ...
            og_dollar = 100
            final_dollar = 100
    return render(request, "plans/checkout.html", {'plan':plan, 'coupon':coupon, 'price':price, 'og_dollar':og_dollar, 'final_dollar':final_dollar,'coupon_dollar':coupon_dollar})
